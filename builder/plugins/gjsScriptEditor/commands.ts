...
export default (editor: Editor, opts: any = {}) => {
  ...
  cm.add(cmdId, {
    ...
    getContentActions() {
      ...
      runLogic.className = "fa fa-bug"; //@ts-ignore
      runLogic.style =
